...
*/ function concatenaStringhe(str1, str2) {
  // Seleziona i primi 2 caratteri dalla prima stringa
  const selezionataStr1 = str1.slice(0, 2);

  // Seleziona gli ultimi 3 caratteri dalla seconda stringa
  const selezionataStr2 = str2.slice(-3);

  // Concatena le stringhe selezionate
  const risultato = selezionataStr1 + selezionataStr2;
...
function filtraValoriPari(array) {
  // Filtra gli elementi pari dall'array
...
const risultat = filtraValoriPari(arrayNumerico);
